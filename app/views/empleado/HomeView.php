...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <span class="navbar-text text-white">Panel de Empleado</span>
        </div>
    </nav>
...
<section id="inicio" class="content-section active-section">
    <div class="container mt-4 text-center">
        <h1 class="display-4">BIENVENIDO AL PANEL DE EMPLEADO DE FLORERÍA MACUS</h1>
...
<section id="ventas" class="content-section">
                    ...
                    <form id="formVenta">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="clienteRFC" class="form-control" required>
                            </div>
                            <div class="col-md-6">
    ...
    <section id="clientes" class="content-section">
        ...
        <!-- Botón para abrir el modal -->
        <button class="btn btn-success my-3" data-bs-toggle="modal" data-bs-target="#modalRegistrarCliente">Nuevo Registro</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formCliente">
                        ...
                        <!-- Datos adicionales para clientes frecuentes -->
                        <div id="datosFrecuente" style="display: none;">
                            <div class="row mb-3">
                                <div class="col">
                                    <label class="form-label">RFC Cliente</label>
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="puntosCliente">
                                </div>
                            </div>
                        </div>
